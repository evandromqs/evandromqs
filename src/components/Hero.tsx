...
export const Hero: React.FC = () => {
  ...
  return (
    <section
      id="hero"
      style={{
        background: 'radial-gradient(ellipse at 50% 35%, #f0fdf4 0%, rgba(240, 253, 244, 0.45) 55%, transparent 100%)',
      }}
    >
      <div className="hero-content">
        ...
        <p className="hero-description" style={{ color: '#334155', fontWeight: 600 }}>
        ...
        <div className="hero-cta-group">
          ...
          >
            ...
            <span>Solicitar Orçamento Grátis no WhatsApp</span>
          </a>
